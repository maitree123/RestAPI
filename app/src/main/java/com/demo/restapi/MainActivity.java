...
import com.demo.restapi.API.GsonRequest;
import com.demo.restapi.API.SingleTonRequest;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void GETStringAndJSONRequest(String page_1, String page_2) {
        ...
        RequestQueue queue = SingleTonRequest.getInstance(getApplicationContext()).getRequestQueue();
    ...
    private void imageLoader() {
        RequestQueue mRequestQueue = SingleTonRequest.getInstance(getApplicationContext()).getRequestQueue();
